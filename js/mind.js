					...
					for (var i = 1; i < items.length; i++) {
						if(items[i].recommend>=4){
							content = content + '<div class="card"><a id="' + items[i].id + '" data-gallery="manual" href="' + items[i].src +
								...
								'</div><div class="p-2 ml-auto"><span class="badge badge-pill badge-warning">' + items[i].recommend +
								'</div><div class="p-2"><span class="badge badge-pill badge-danger">' + items[i].category +
